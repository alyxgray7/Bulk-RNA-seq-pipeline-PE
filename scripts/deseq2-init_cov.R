...
help <- function() {
  ...
  \n")
  cat("--covariate        : [ required ] Column in metadata file that contains the covariate attribut to include in DE model.")
  cat("\n")
  q()
}
...
#   outDir = "/home/groups/CEDAR/grayaly/projects/platelet/plt-rnaseq/full-cohort/Bulk-RNA-seq-pipeline-PE_02162022/results/diffexp/covariate_test",
#   metaFile = "/home/groups/CEDAR/grayaly/projects/platelet/plt-rnaseq/full-cohort/Bulk-RNA-seq-pipeline-PE_02162022/data/pltRNAseq_metadata_02282022.tsv",
...
print(paste0("Covariate: ", io$covariate))

output <- paste0(io$outDir, "/", paste0(target, "-vs-", baseline), "_cov_all.rds")
print(output)

rld_out <- paste0(io$outDir, "/", paste0(target, "-vs-", baseline), "_cov_rlog_dds.rds")
print(rld_out)
...
# # create a new "group" column that pastes together the covariates included in DE model
# md[["cov"]] <- paste(md[[io$Type]], md[[io$covariate]], sep = ".")
# head(md)
